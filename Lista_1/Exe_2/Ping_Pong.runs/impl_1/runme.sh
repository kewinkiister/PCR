...
HD_PWD='/home/parallels/Desktop/ProjetosVivado/Ping_Pong/Ping_Pong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ping_pong_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ping_pong_leds.tcl -notrace
