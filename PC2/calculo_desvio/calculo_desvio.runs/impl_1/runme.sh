...
HD_PWD='/home/filipesfreitas/Documentos/calculo_desvio/calculo_desvio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log desvio_velocidade.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source desvio_velocidade.tcl -notrace
