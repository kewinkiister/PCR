...
HD_PWD='/home/filipesfreitas/Documentos/calculo_desvio/calculo_desvio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log desvio_velocidade.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source desvio_velocidade.tcl
