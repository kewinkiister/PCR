...
HD_PWD='/home/parallels/Desktop/ProjetosVivado/PCR_P1/Neoronio_2.runs/ROMmenXul_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROMmenXul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROMmenXul.tcl
