...
HD_PWD='/home/parallels/Desktop/ProjetosVivado/PCR_P1/Neoronio_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neuronio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neuronio.tcl
